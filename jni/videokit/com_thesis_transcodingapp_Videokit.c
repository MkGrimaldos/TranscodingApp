...
#include "logjam.h"
#include "com_thesis_transcodingapp_Videokit.h"
...
JNIEXPORT void JNICALL Java_com_thesis_transcodingapp_Videokit_run (JNIEnv *env, jobject obj, jobjectArray args)
{
	int i = 0;
	int argc = 0;
	char **argv = NULL;
